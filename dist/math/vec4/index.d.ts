...
export { GetVec4Distance, GetVec4DistanceSquared, GetVec4Length, GetVec4LengthSquared, GetVec4ManhattanDistance, GetVec4ManhattanLength, RGBACallback, Vec4, Vec4Abs, Vec4Add, Vec4AddScalar, Vec4Bezier, Vec4Callback, Vec4CatmullRom, Vec4Ceil, Vec4Center, Vec4Clamp, Vec4ClampLength, Vec4ClampScalar, Vec4Clone, Vec4CopyFrom, Vec4Cross, Vec4Divide, Vec4DivideScalar, Vec4Dot, Vec4Equals, Vec4Floor, Vec4Fract, Vec4FuzzyEquals, Vec4Hermite, Vec4Lerp, Vec4Max, Vec4Min, Vec4Multiply, Vec4MultiplyByFloats, Vec4Negate, Vec4Normalize, Vec4One, Vec4Random, Vec4Round, Vec4RoundToZero, Vec4Scale, Vec4ScaleAndAdd, Vec4SetLength, Vec4Subtract, Vec4SubtractScalar, Vec4TransformMat4, Vec4Zero };
