...
export { AddTransform2DComponent, BoundsIntersects, CopyLocalToWorld, CopyWorldToWorld, GetLocalBounds, GetLocalTransform, GetRotation, GetScaleX, GetScaleY, GetSkewX, GetSkewY, GetWorldTransform, GetX, GetY, GlobalToLocal, IsInView, IsRootTransform, LocalToGlobal, MultiplyLocalWithWorld, Origin, Position, Scale, SetBounds, SetExtent, SetInView, SetInViewFromBounds, SetRootTransform, Size, Skew, Transform2DComponent, UpdateAxisAligned, UpdateExtent, UpdateTransforms, UpdateWorldTransform };
