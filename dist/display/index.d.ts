...
export { AddChild, AddChildAt, AddChildren, AddChildrenAt, AddPosition, AddRotation, AddScale, AddSkew, BringChildToTop, ConsoleTreeChildren, CountMatchingChildren, DepthFirstSearch, DepthFirstSearchRecursive, DepthFirstSearchRecursiveNested, DestroyChildren, FindChildByName, FindChildrenByName, GetAllChildren, GetBounds, GetChildAt, GetChildIndex, GetChildren, GetClosestChild, GetFirstChild, GetFurthestChild, GetLastChild, GetParents, GetRandomChild, MoveChildDown, MoveChildTo, MoveChildUp, OverlapBounds, RemoveChild, RemoveChildAt, RemoveChildren, RemoveChildrenAt, RemoveChildrenBetween, ReparentChildren, RotateChildrenLeft, RotateChildrenRight, SendChildToBack, SetBounds, SetChildrenValue, SetName, SetOrigin, SetParent, SetPosition, SetRotation, SetScale, SetSize, SetSkew, SetType, SetValue, SetVisible, SetWorld, ShuffleChildren, SwapChildren };
