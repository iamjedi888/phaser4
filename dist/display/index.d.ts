...
export { AddChild, AddChildAt, AddChildren, AddChildrenAt, AddPosition, AddRotation, AddScale, AddSkew, BringChildToTop, ConsoleTreeChildren, CountMatchingChildren, DepthFirstSearch, DepthFirstSearchRecursive, DestroyChildren, DisplayDebugTools, FindChildrenByName, GetAllChildren, GetBounds, GetChildAt, GetChildIndex, GetChildren, GetClosestChild, GetFirstChild, GetFirstChildByName, GetFurthestChild, GetLastChild, GetParents, GetRandomChild, MoveChildDown, MoveChildUp, OverlapBounds, RemoveChild, RemoveChildAt, RemoveChildren, RemoveChildrenAt, RemoveChildrenBetween, ReparentChildren, RotateChildrenLeft, RotateChildrenRight, SendChildToBack, SetChildrenValue, SetName, SetOrigin, SetPosition, SetRotation, SetScale, SetSize, SetSkew, SetValue, SetVisible, SetWorld, ShuffleChildren, SwapChildren };
