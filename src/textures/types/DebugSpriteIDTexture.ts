...
export function DebugSpriteIDTexture (cellWidth: number = 32, cellHeight: number = 32, cols: number = 32, rows: number = 32): Texture
{
    const ctx = CreateCanvas(cellWidth * cols, cellHeight * rows);

    const colors = [
        '#e27458', '#e89361', '#f0b26b', '#fff57e',
        '#b4d27e', '#8dc37e', '#62b57e', '#58b8b3',
        '#44bced', '#568ac5', '#5c73b4', '#605ca3',
        '#8061a4', '#9e67a5', '#e076a8', '#e1757f'
    ];
